    ...
    public static class FileHelper
    {
        ...
        public static void ErrorLog(string exMessage, string exMethod, int userID)
        {
            try
            {
                ...
                string errPath = System.AppDomain.CurrentDomain.BaseDirectory + errVir;
        ...
        {
            string errPath = System.AppDomain.CurrentDomain.BaseDirectory + string.Format("Log\\Debug\\{0}.txt", DateTime.Now.ToShortDateString());
